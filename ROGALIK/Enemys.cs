...
namespace ROGALIK
{
    class Character
    {
        ...
        public Character(string[] heroStats, int mapX, int mapY, char[,] map) // для врага =============================================================
        {
            ...
            Armor = Convert.ToInt32(heroStats[5]);
            Vision = Convert.ToInt32(heroStats[8]);
            Live = Convert.ToInt32(heroStats[9]);
            ...
            while (true)
            {
                ...
                if (map[coorX, coorY] != '#' && map[coorX, coorY] != 'O' && map[coorX, coorY] != '░' && map[coorX, coorY] != '║' && map[coorX, coorY] != '╚' && map[coorX, coorY] != '╔' && map[coorX, coorY] != '╗' && map[coorX, coorY] != '╝' && map[coorX, coorY] != '═' && map[coorX, coorY] != '╩' && map[coorX, coorY] != '╠' && map[coorX, coorY] != '╣' && map[coorX, coorY] != '╬' && map[coorX, coorY] != '╦')
                {
                    X = coorX;
                    Y = coorY;
                    break;
        ...
        public void ChekLiveEnemy(int live)
        {
    ...
    class EnemySad : Character // Легкий враг =======================================================
    {
        ...
        public int Atack(int heroX, int heroY)
        {
            double num = (X - heroX) * (X - heroX) + (Y - heroY) * (Y - heroY);
        ...
        public void YaZametilTebyaBegiTvar(int heroX, int heroY, char[,] map, int hp)
        {
            int MoveToHero = 0;
